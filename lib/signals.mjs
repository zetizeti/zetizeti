...
export function computeSignals({ goal = '', lineage = [], studentTurns = [], stoneTurns = [], exchanges = 0, semFresh = null } = {}) {
  ...
  // it is how a session spends eleven turns on one axis (Siddhie, 26 Jul 2026: eleven consecutive
  ...
  // a bored student stops writing before they start repeating (Siddhie's replies fell from ~40 words to
