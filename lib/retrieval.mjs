...
// 🔴 A NEW LENS FILE DOES NOTHING UNTIL ITS DISCIPLINE IS NAMED HERE. `withholding` was added on
// 20 September 2026 with corpus/domain/withholding.md; without this line those five entries
// would index, retrieve and rank as ordinary field material and never once behave as a lens —
// no error, no failing test. That is the fault the comment above describes, arriving a fifth time.
export const LENS_DISCIPLINES = ['memorability', 'slow-design', 'critical-design', 'counterculture', 'attention-economy', 'entrepreneurship', 'manufacturing', 'money-career', 'diy-hacking', 'withholding', 'own-purpose'];
