...
export const LENS_DISCIPLINES = ['memorability', 'slow-design', 'critical-design', 'counterculture', 'attention-economy', 'entrepreneurship', 'manufacturing', 'money-career', 'diy-hacking', 'withholding'];
