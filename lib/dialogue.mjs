...
export function buildCriticismSystemPrompt(criticismCore, { artefact = '', located = null, posture = '', retrieved = [], goal = '', focus = null } = {}) {
  const passages = retrieved.length
...
${criticismCore}
${artefactBlock}${goalBlock}${focusBlock}${aimBlock}${spot}
...
export function validateCriticismOutput(text, { focus = null } = {}) {
