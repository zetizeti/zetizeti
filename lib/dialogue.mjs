...
// ---------------------------------------------------------------------------------------------------
// THE SPECCING SURFACE (v0.25.0). A student's own SPECIFICATION is the object; the six joints in
...
export function buildSpecSystemPrompt({ spec = '', assignment = '', joint = null, asked = [],
  ...
  const jointBlock = joint
    ? `\n== THE LINE OF QUESTIONING FOR THIS TURN — ${joint.label} ==\n${joint.aim}\n🔴 Ask about THIS, in ONE question, using their own words. If their specification says nothing about it, do NOT say so and do NOT name what is missing — ask what theirs does at that place and let them discover the gap by trying to answer.\n`
    : '';
...
- Ask what hers does, holds, decides or shows. Not what it should do.
