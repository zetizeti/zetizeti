...
// The discipline clause was removed on 7 September 2026 with the rest of the discipline logic — the
// picker had been gone for months and every caller passed 'all', so this always rendered empty.
